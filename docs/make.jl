...
DocMeta.setdocmeta!(TimeFloats, :DocTestSetup, :(using TimeFloats); recursive = true)
...
makedocs(;
    modules = [TimeFloats],
    authors = "Yakir Gagnon <12.yakir@gmail.com>",
    repo = "https://github.com/yakir12/TimeFloats.jl/blob/{commit}{path}#{line}",
    sitename = "TimeFloats.jl",
    format = Documenter.HTML(; canonical = "https://yakir12.github.io/TimeFloats.jl"),
    pages = list_pages(),
)

deploydocs(; repo = "github.com/yakir12/TimeFloats.jl")
